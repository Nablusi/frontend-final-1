...
export default function PopsUp() {
  ...
  return (
    <Dialog sx={PopsUpStyles.dialog(theme)} open={open} onClose={handleClose}>
      <DialogTitle sx={PopsUpStyles.dialogTitle}>
        <Button
          sx={PopsUpStyles.buttonDialogTitle(theme)}
          onClick={handleClose}
        >
                ...
                <Box component={"div"} sx={PopsUpStyles.boxListItem}>
                  ...
                  <Box component={"div"} sx={PopsUpStyles.cardBody}>
                    ...
                    <Box component={"div"} sx={PopsUpStyles.cardFooter}>
                      <Box
                        component={"div"}
                        sx={PopsUpStyles.numberLine(theme)}
                      >
                        <IconButton
                          onClick={() => decrementHandler(index)}
                          sx={PopsUpStyles.plusMinusIcons}
                        >
                          <RemoveIcon />{" "}
                        </IconButton>
